package jp.ac.it_college.std.s22028.listviewsample2
...
class OrderConfirmDialogFragment: DialogFragment() {
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog =
        AlertDialog.Builder(requireActivity())
            ...
            .setNegativeButton(R.string.dialog_btn_nu, dialogButtonClickListener)
            .create()
    ...
    private val  dialogButtonClickListener =
        DialogInterface.OnClickListener { dialog, which ->
            val msg = when (which) {
                ...
                DialogInterface.BUTTON_NEGATIVE -> getString(R.string.dialog_ok_toast)
                DialogInterface.BUTTON_NEUTRAL -> getString(R.string.dialog_ok_toast)
